...
namespace ServicesPlomberie.Controllers
{
    public class PostsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PostId,Description,Id")] Post post)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("PostId,Description,Id")] Post post)
        {
            if (id != post.Id)
            {
                return NotFound();
